...
<!--   sidebar-->
    ...
    <div id="myNav" class="navbar-overlay"> 
        ...
        <div id="nav-accordion">
                ...
                <ul class="pl10">
                <a href="/about-us/#values" aria-label="Our Values">
                     <li>
                         <span class="angle-icon">Our Values  <i class="fas fa-chevron-right"></i></span>
                     </li>
                 </a>
                 <a href="/about-us/partner" aria-label="Our Partners">
                     <li>
                         <span class="angle-icon">Partners  <i class="fas fa-chevron-right"></i></span>
                     </li>
                 </a>
                 <a href="/awards" aria-label="Our Partners">
                     <li>
                         <span class="angle-icon">Awards & Recognitions <i class="fas fa-chevron-right"></i></span>
                     </li>
                 </a>
                 <a href="/pricing" aria-label="Our Pricing">
                     <li>
                         <span class="angle-icon">Pricing  <i class="fas fa-chevron-right"></i>
                         </span>
             ...
             <a href="/support" aria-label="Support">
                     <li>
                         <span class="angle-icon">Support  <i class="fas fa-chevron-right"></i>
                         </span>
             ...
             <a href="/faq" aria-label="FAQ's">
                 <li>
                     <span class="angle-icon">FAQ's  <i class="fas fa-chevron-right"></i>
                     </span>
                 </li>
             </a>
             <a href="/careers" aria-label="Careers">
                 <li>
                     <span class="angle-icon">Careers  <i class="fas fa-chevron-right"></i></span></li>
         </a>
     </ul></div>
                                        </div>
                                    </div>
         ...
         <a href="/services-grid/web-and-mobile-app-development" aria-label="Learn More Web/Mobile App Development">
             <li>
                 <span class="angle-icon">Web/Mobile App Development  <i class="fas fa-chevron-right"></i>
                 </span>
             </li>
         </a>
         ...
         <a href="/services-grid/ppc" aria-label="Paid Search Management">
             <li>
                 <span class="angle-icon">Paid Search Management  <i class="fas fa-chevron-right"></i></span></li>
         </a>
         <a href="/services-grid/landing-pages" aria-label="Landing Pages">
             <li>
                 <span class="angle-icon">Landing Pages  <i class="fas fa-chevron-right"></i></span></li>
         </a>
         <a href="/services-grid/marketing-automation" aria-label="Marketing Automation">
             <li>
                 <span class="angle-icon">Marketing Automation  <i class="fas fa-chevron-right"></i></span></li>
         </a>
         <a href="/services-grid/data-visualization" aria-label="Data Visualization">
             <li>
                 <span class="angle-icon">Data Visualization  <i class="fas fa-chevron-right"></i></span></li>
         </a>
         ...
         <a href="/services-grid/email-services" aria-label="Email Services">
             <li>
                 <span class="angle-icon">Email Services  <i class="fas fa-chevron-right"></i></span></li>
         </a>
                 ...
                 <span class="angle-icon">E-Commerce  <i class="fas fa-chevron-right"></i></span>
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapsework" class="collapse" aria-labelledby="our-work-menu" data-parent="#nav-accordion">
                                        ...
                                        <div class="sub-sub-menu"> 
    <ul class="pl10">
    <a href="/our-work.php#case-studies" aria-label="Case Studies">
                     <li>
...
<li class="nav-menu-item">
<a href="/events" aria-label="Our Events">
...
<li class="nav-menu-item">
<a href="/start" aria-label="Start Your Project" class="btn-yellow">
 Start Your Project  ➞
</a>
</li>
...
<li><div class="side-image">
    <img
    data-class="LazyLoad" src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==' data-src="/images/grow-with-google-300x200.png"
     width="300"
     height="200"
...
<a href="tel:+1 630 999 (7768)" class="num" aria-label="Call Us">
...
<!-- SIDEBAR -->
 <div class="scroll-top">
   <a href="#" class="up-icon-fixed"> <i class="fas fa-caret-up"></i></a>
  </div>
...
<input type="checkbox" id="toggle-input">
        ...
        <ul class="toggle-content">
            ...
            <li>
                <a aria-label="Call Us" href="tel:+1 630 999 7768" class="tool side-icon mt3px call" data-tip="Phone"><i class="fas fa-phone"></i></a>
            </li>
            <li>
                <a aria-label="Text" href="sms:+1 630 999 7768" class="tool side-icon" data-tip="Text"><i class="fas fa-sms"></i></a>
            </li>
            <li>
            ...
            <li>
                <span aria-label="Location" data-toggle="modal" data-target="#reviews-modal"  class="tool side-icon" data-tip="Google Reviews"><i class="fas fa-star"></i></span>
            </li>
        </ul>
</div>
</section>
...
<div class="reviews-widget modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true" id="reviews-modal">
 <div class="modal-dialog modal-dialog-centered review-dialog" role="document">
  <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">What our customers say</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true" class="review-close">&times;</span>
        </button>
      </div>
      <div class="modal-body">
    <?php include 'tes1.php'; ?>
  </div>
  </div>
</div>
</div> 
