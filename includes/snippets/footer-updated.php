...
<div class="light-blu-bg ns-new-footer">
                ...
                <div class="col-xl-3 col-lg-12 col-sm-12 col-xs-12">
                    <ul class="abt-ftr">
                        <li class="ftr-logo-list">
                           <a href="/" aria-label="Home Page"> <img data-class="LazyLoad" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="  data-src="/images/new-ns-clear-logo.png" width="184" height="80"  class="ftr-logo" alt="image"></a>
                        </li>
                        <li>
                            ...
                            <p><a href="/contact-us" aria-label="Contact Us"><u>Contact</u></a> us today to get your project <a href="/start" aria-label="Start Your Project"><u>started</u></a>.</p>    
                    ...
                    <div class="row align-center">
                        <div class="col-md-6 col-xs-6 mtb-1">
                            <img data-class="LazyLoad" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="  data-src="/images/threerated-png.png" width="600" height="600"   alt="image">
                           
                        </div>
                        
                        <div class="col-md-6 col-xs-6 mtb-1">
                            <img data-class="LazyLoad" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="  data-src="/images/up-city-png.png" width="1000" height="1000"  alt="image">
                            
                        </div>
                        <div class="col-md-6 col-xs-6 mtb-1">
                            <img data-class="LazyLoad" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="  data-src="/images/new-seo-footer.png" width="222" height="200"   alt="image">
                        </div>
                        <div class="col-md-6 col-xs-6 mtb-1">
                            <a href="https://www.google.com/partners/agency?id=7535556500" target="_blank" rel="noopener" aria-label="Google Partner Agency">
                                <img data-class="LazyLoad" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="  data-src="/images/google-partner-RGB-search-mobile-disp.png" width="806" height="446"  alt="image">
                            </a>
                        </div>
                        ...
                        <ul class="abt-ftr-icons-list">
                            <li><a href="tel: +1 630 999 (7768)" aria-label="Call Us at +1 630 999 (7768)"><i class="fas fa-phone abt-ftr-icon"></i> </a></li>
    ...
    <li><a href="/category/amp" aria-label="Accelerated Mobile Pages">AMP</a></li>
                            ...
                            <li><a href="/certification" aria-label="Our Expertise">Expertise</a></li>
                            ...
                            <li><a href="/google-third-party-partner-policy-disclosure-notice" aria-label="Our Terms & Conditions">T&C's</a></li>
                ...
                <div class="col-xl-9 col-lg-12 col-sm-12 col-xs-12">
                    <div class="row">
                    <div class="col-lg-3 col-md-12 col-xs-12 tab-footer-none">
                        <h4 class="ftr-list-head">Blog Categories</h4>
                    ...
                    <div class="col-lg-3 col-md-12 col-xs-12 tab-footer-none">
                        <h4 class="ftr-list-head">Site Map</h4>
                        <ul  class="ftr-list ftr-list-two">
                            <li><a href="/about-us.php" aria-label="About Us">About</a></li>
                            <li><a href="/careers" aria-label="Careers">Careers</a></li>
                            <li><a href="/about-us/partner" aria-label="Our Partners">Partners</a></li>
                            ...
                            <li><a href="/services" aria-label="Services">Services</a></li>
                             <li><a href="/contact-us" aria-label="Contact Us">Contact</a></li>
                             <li  class="map-100"><a href="/contact-us#frame" aria-label="Get Directions">Map & Directions</a></li>
                    ...
                    <div class="col-lg-3 col-md-12 col-xs-12 tab-footer-none">
                        <h4 class="ftr-list-head">Services</h4>
                        <ul  class="ftr-list">
   ...
   <div class="col-lg-3 col-md-6 col-sm-8 mx-auto tab-padtb-31">
                    <form target="hidden_iframe" onsubmit="submitted=true;" method="post" action="https://app.getresponse.com/add_subscriber.html">
                        <h4 class="ftr-list-head">Get Complimentary Audit</h4>
                        <ul class="ftr-form-ul tab-padt-15">
                            <li class="email">
                            <label for="cwu" class="hidden">Custom Website URL</label>
                                <input type="text" id="cwu" name="custom_website_url" placeholder="www.yourdomain.com" required class="ftr-input"> </li>
                            <li>
                            ...
                            <li>
                            <input type="hidden" name="campaign_token" value="zuKDs" />
                            <input type="hidden" name="start_day" value="0" />
                            <input type="submit"  class="ftr-input ftr-submit" value="Send My Audit Report">
                            </li>
                        </ul>
                        <a href="/NectarSpot-Brochure.pdf" target="_blank" rel="noopener" aria-label="Download Our Brochure">
                            <button type="button" class="ftr-input ftr-submit" aria-label="Download Brochure">Download Brochure <i class="fas fa-download"></i></button>
                        </a>
                    </form>
                    </div>
...
<div class="form-logos">
                        ...
                        <ul class="flex-logos">
                            <li class="item image-box gwg-image-box">
                                <img width="300" height="200" data-class="LazyLoad" src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==' data-src="/images/grow-with-google-300x200-transparent.png" alt="image">
                            </li>
                            <li class="item image-box">
                                <img width="200" height="200" data-class="LazyLoad" src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==' data-src="/images/upcity-200x200.jpg" alt="image">
                            </li>
                            <li class="item image-box">
                                <img width="200" height="200" data-class="LazyLoad" src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==' data-src="/images/three-rated-200x200.jpg" alt="image">
                            </li>
                            <li class="item image-box">
                                <img width="200" height="200" data-class="LazyLoad" src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==' data-src="/images/seo-200x200.jpg" alt="image">
                            </li>
                            <li class="item image-box gwg-image-box">
                                <img  width="806" height="446"  data-class="LazyLoad" src='data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==' data-src="/images/google-partner-RGB-search-mobile-disp.png" alt="image">
                            </li>
                        </ul>
...
<div class="copy-right-div">
    <div class="container">
     <div class="row align-center">
                <div class="col-lg-7 col-md-12 col-xs-12"><p class="copy-right-text">Copyright © 2020 Website by <a href="https://nectarspot.com/" aria-label="Home Page" class="ns-ftr-link"> NectarSpot Marketing, Automation, and Design Company</a> </p> </div>
                <div class="col-lg-5 col-md-12 col-xs-12">
                    <ul class="social-icons-list">
                        ...
                        <li><a href="/"><i class="fas fa-home home-icon" aria-label="Home Page"></i></a></li>
                    </ul>
                </div>
                </div>
                  </div>
...
var $zoho=$zoho || {};$zoho.salesiq = $zoho.salesiq || {widgetcode:"6523d9f86c930cbedabc00ef637709d71840fcd25cda8e1bd2ddf829515a614c", values:{},ready:function(){}};var d=document;s=d.createElement("script");s.type="text/javascript";s.id="zsiqscript";s.defer=true;s.src="https://salesiq.zoho.com/widget";t=d.getElementsByTagName("script")[0];t.parentNode.insertBefore(s,t);d.write("<div id='zsiqwidget'></div>");
</script>  
   <script>
